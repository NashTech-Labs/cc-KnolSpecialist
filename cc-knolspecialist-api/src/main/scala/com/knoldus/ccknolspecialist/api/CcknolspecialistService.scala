package com.knoldus.ccknolspecialist.api
...
object CcknolspecialistService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The cc-KnolSpecialist service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the CcknolspecialistService.
  */
trait CcknolspecialistService extends Service {
  ...
  override final def descriptor = {
    import Service._
    // @formatter:off
    named("cc-knolspecialist")
      .withCalls(
        pathCall("/api/hello/:id", hello _),
        pathCall("/api/hello/:id", useGreeting _)
      )
      .withTopics(
        topic(CcknolspecialistService.TOPIC_NAME, greetingsTopic _)
